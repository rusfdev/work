...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_gsap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/gsap */ "./src/assets/scripts/modules/gsap.js");
/* harmony import */ var _modules_custom_interaction__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/custom-interaction */ "./src/assets/scripts/modules/custom-interaction.js");
/* harmony import */ var _modules_breakpoints__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/breakpoints */ "./src/assets/scripts/modules/breakpoints.js");
/* harmony import */ var _modules_animation_duration__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/animation-duration */ "./src/assets/scripts/modules/animation-duration.js");
/* harmony import */ var _modules_test_screen__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/test-screen */ "./src/assets/scripts/modules/test-screen.js");
...
function PlayStartAnimation() {
  ...
  var animation = _modules_gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline({
    ...
    autoAlpha: 1,
    duration: _modules_animation_duration__WEBPACK_IMPORTED_MODULE_3__["sDur"][2]
  }).fromTo(lightEl, {
    scale: 0.2
  }, {
    scale: scale,
...
var ScrollToAnchor = {
  init: function init() {
    ...
    var triggerSelector = '[data-action="ScrollToAnchor"]';

    var clickEvent = function clickEvent(event) {
      var triggerElement = event.target.closest("".concat(triggerSelector));
      if (!triggerElement) return;
      event.preventDefault();
      var attr = triggerElement.getAttribute('href'),
          targetElement = document.querySelector("".concat(attr));
    ...
    var scrollEvent = function scrollEvent(targetElement) {
      ...
      _this.animation = _modules_gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(window, {
        scrollTo: scrollY,
        duration: _modules_animation_duration__WEBPACK_IMPORTED_MODULE_3__["sDur"][3],
        onComplete: function onComplete() {
...
/***/ "./src/assets/scripts/modules/animation-duration.js":
/*!**********************************************************!*\
  !*** ./src/assets/scripts/modules/animation-duration.js ***!
  \**********************************************************/
/*! exports provided: sDur, msDur */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sDur", function() { return sDur; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "msDur", function() { return msDur; });
var msDur = {
  1: 150,
  2: 300,
  3: 500,
...
/***/ "./src/assets/scripts/modules/breakpoints.js":
/*!***************************************************!*\
  !*** ./src/assets/scripts/modules/breakpoints.js ***!
  \***************************************************/
/*! exports provided: default */
...
/***/ "./src/assets/scripts/modules/custom-interaction.js":
/*!**********************************************************!*\
  !*** ./src/assets/scripts/modules/custom-interaction.js ***!
  \**********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return СustomInteraction; });
...
/* harmony import */ var _throttle__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./throttle */ "./src/assets/scripts/modules/throttle.js");
...
var СustomInteraction = /*#__PURE__*/function () {
  function СustomInteraction(options) {
    var _this2 = this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, СustomInteraction);

    var _this = this;

    this._maxTargetsLength = 10;
    this._mainSelector = '[data-custom-interaction]';
    this._selectors = (options === null || options === void 0 ? void 0 : options.targets) || [];
    ...
    this._targets = new Proxy({}, {
      defineProperty: function defineProperty(targets, key, property) {
        var target = property.value.target;
        var event = property.value.event;
        target.setAttribute("data-".concat(event), ''); //create event

        target.dispatchEvent(new CustomEvent("custom:".concat(_this._events[event][0]), {
          bubbles: true
        }));
        targets[key] = property.value;
        return true;
      },
      deleteProperty: function deleteProperty(targets, key) {
        var target = targets[key].target;
        var event = targets[key].event;
        target.removeAttribute("data-".concat(event)); //create event

        target.dispatchEvent(new CustomEvent("custom:".concat(_this._events[event][1]), {
          bubbles: true
        }));
        delete targets[key];
        return true;
    ...
    document.addEventListener('mouseenter', function (event) {
      _this2._mouseEnterEvent(event);
    }, true);
    document.addEventListener('mouseleave', function (event) {
      _this2._mouseLeaveEvent(event);
    }, true);
    document.addEventListener('touchstart', function (event) {
      _this2._touchStartEvent(event);
    });
    document.addEventListener('touchend', function () {
      _this2._touchEndTimeout = setTimeout(function () {
        _this2._clearTouchedElements();

        delete _this2._touchEndTimeout;
      }, 250);
    });
    document.addEventListener('contextmenu', function () {
      _this2._clearTouchedElements();
    });
    this._checkOnMouseMoveThrottle = Object(_throttle__WEBPACK_IMPORTED_MODULE_2__["default"])(this._checkOnMouseMove, 500, this);
    document.addEventListener('mousemove', function (event) {
      _this2._checkOnMouseMoveThrottle(event);
    });
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(СustomInteraction, [{
    key: "_generateUniqueKey",
    value: function _generateUniqueKey() {
      var availableKeys = [];

      for (var index = 1; index <= this._maxTargetsLength; index++) {
      ...
      if (!availableKeys.length) {
        ...
        var randomIndex = Math.round(Math.random() * (availableKeys.length - 1));
        return availableKeys[randomIndex];
      }
    }
  }, {
    key: "_createMutationObserver",
    value: function _createMutationObserver() {
      var _this3 = this;
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            if (mutation.type === 'attributes' && mutation.attributeName === 'disabled' && mutation.target.getAttribute('disabled') !== null) {
              for (var key in _this3._targets) {
                if (_this3._targets[key].target == mutation.target) {
                  delete _this3._targets[key];
                }
              }
            }
          }
    ...
    key: "_checkOnMouseMove",
    value: function _checkOnMouseMove(event) {
      for (var key in this._targets) {
        var target = this._targets[key].target;
        var x1 = target.getBoundingClientRect().left;
        var x2 = x1 + target.getBoundingClientRect().width;
        var y1 = target.getBoundingClientRect().top;
        var y2 = y1 + target.getBoundingClientRect().height;
    ...
    value: function _touchStartEvent(event) {
      var _this4 = this,
          _targets$;
      ...
      this._touchedTimeout = setTimeout(function () {
        delete _this4._touched;
        delete _this4._touchedTimeout;
      }, 1000);
      var targets = [event.target.closest(this._selector)];
      if (!targets[0] || ((_targets$ = targets[0]) === null || _targets$ === void 0 ? void 0 : _targets$.getAttribute('disabled')) !== null) return;
    ...
    key: "_clearTouchedElements",
    value: function _clearTouchedElements() {
      for (var key in this._targets) {
    ...
    value: function _mouseEnterEvent(event) {
      var target = event.target !== document && event.target.closest(this._selector) == event.target ? event.target : false;
...
/***/ "./src/assets/scripts/modules/gsap.js":
/*!********************************************!*\
  !*** ./src/assets/scripts/modules/gsap.js ***!
  \********************************************/
/*! exports provided: default */
...
/* harmony import */ var _animation_duration__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./animation-duration */ "./src/assets/scripts/modules/animation-duration.js");
...
gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].registerEffect({
  name: "fadeIn",
  effect: function effect($element, config) {
    return gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].fromTo($element, {
      autoAlpha: 0
    }, {
      immediateRender: false,
      autoAlpha: 1,
      duration: config.duration || _animation_duration__WEBPACK_IMPORTED_MODULE_2__["sDur"][1],
      onStart: function onStart() {
        $element.forEach(function ($this) {
...
/* harmony default export */ __webpack_exports__["default"] = (gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"]);

/***/ }),

/***/ "./src/assets/scripts/modules/test-screen.js":
/*!***************************************************!*\
  !*** ./src/assets/scripts/modules/test-screen.js ***!
  \***************************************************/
/*! exports provided: default */
...
function checkScrollbar() {
  ...
  var testWidth = testDiv.getBoundingClientRect().width;
  var value = testWidth - testDiv.clientWidth;
  testDiv.remove(); //set scrollbar params

  document.documentElement.style.setProperty('--scrollbar-width-property', "".concat(value, "px"));
}

/* harmony default export */ __webpack_exports__["default"] = (function () {
  if (current_device__WEBPACK_IMPORTED_MODULE_0__["default"].ios()) {
    document.documentElement.style.setProperty('--window-safe-height-property', "".concat(window.innerHeight, "px"));
  }
...
/***/ "./src/assets/scripts/modules/throttle.js":
/*!************************************************!*\
  !*** ./src/assets/scripts/modules/throttle.js ***!
  \************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (function (func, interval, context) {
